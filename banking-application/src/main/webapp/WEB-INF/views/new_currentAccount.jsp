        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              <h2 class="text-uppercase text-center mb-5">Account successfully created</h2>



<% CurrentAccount a = (CurrentAccount)session.getAttribute("currentAccount"); %>
<% AccountHolder b = (AccountHolder)session.getAttribute("loggedInCustomer"); %>
...
<a href="current_accounts" class="btn btn-primary"> Make a transaction </a> <br>
